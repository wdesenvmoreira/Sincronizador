...
/*Problemas: Umm pedido que possui vários itens, pode ter vários registros de cancelamento.
 O cancelamento é vinculado ao pedido de venda que possui vinculo com o id do item detalhe.
 Desta forma quando é feito mais de um cancelamento para um item de um pedido outro registro
 de cancelamento é vinculado, com esse vinculo o mesmo id aparece duas vezes.
 outro campo é a data de cancelamento que pode ser diferente para cancelamentos diferentes.
 Neste banco não encontrei mais de um cancelamento por pedido de venda.
 O problema do consultor resolvi encontrando um condicional de só trazer o consultor principal*/
